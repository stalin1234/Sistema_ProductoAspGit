<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CompraProductos.aspx.cs" Inherits="Sistema_Producto.Vistas.CompraProductos" %>
        ...
        <section id="Contenido">
            ...
            <form id="form1" runat="server">
                ...
                <div class="Formularios">
                        ...
                        <br />
                        <br />
                        <asp:TextBox ID="TextBox_Precio" AutoPostBack="true" runat="server" CssClass="CampoTexto" onkeypress="return soloNumDecimal(event);" OnTextChanged="TextBox_Precio_TextChanged"></asp:TextBox>
                        <br />
                    ...
                    <asp:Button ID="Button_Comprar" runat="server" Text="Comprar" BorderStyle="None" CssClass="Button" OnClick="Button_Comprar_Click"/>
                ...
                <div class="Formularios">
                        ...
                        <asp:TextBox ID="TextBox_Proveedor" AutoPostBack=" true" runat="server" ReadOnly="true" CssClass="CampoTexto" ></asp:TextBox>
                        <br />
                ...
                <div class="Formularios">
                    ...
                    <!--<br />-->
                  <asp:GridView ID="GridView2" runat="server" AllowPaging="True" BackColor="White" BorderColor="Lime" BorderStyle="Solid" BorderWidth="2px" CellPadding="4"  PageSize="8" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
                       <AlternatingRowStyle BackColor="White" ForeColor="#ff0066" />
                ...
                <div class="Formularios">
                  ...
                  <asp:Label ID="Label2" runat="server" Text="compras realizadas" Font-Bold="true"></asp:Label>
                  <br />
                  <br />   
                  <asp:GridView ID="GridView3" runat="server" AllowPaging="True" BackColor="White" BorderColor="Lime" BorderStyle="Solid" BorderWidth="2px" CellPadding="4"  PageSize="8" OnPageIndexChanging="GridView3_PageIndexChanging" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
                       <AlternatingRowStyle BackColor="White" ForeColor="#ff0066" />
                ...
                <div class="Formularios">
                  ...
                  <asp:Label ID="Label1" runat="server" Text="Carrito de compras" Font-Bold="true"></asp:Label>
                  <br />
                  <br />
