    ...
    public partial class CompraProductos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack == false)
            {
                ...
                GridView3.DataSource = Connect5.Consultar4("*","Compras", "Fecha", TextBox_Fecha.Text);
                GridView3.DataBind();

                string campos2 = "Id, Categoria, Producto, Precio, Cantidad, Importe";
                GridView4.DataSource = Connect4.Consultar7(campos2, "Compras","Proveedor",TextBox_Proveedor.Text, "Factura", TextBox_Factura.Text);
                GridView4.DataBind();
        ...
        private void GuardarDatos()
        {
                ...
                }else
                {
                    ...
                    else
                    {
                        if(TextBox_Proveedor.Text == "")
                        {
                            ...
                            Label_Proveedor.ForeColor = Color.Red;
                            Label_Proveedor.Text="selecione un proveedor";
                        }
                        else
                        {
                            ...
                            foreach(DataRow row in Connect3.Consultar4("*", "Bodega", "Codigo",IdProducto).Rows)
                            {
                                ...
                                IngresarCant = Cantidad + CantidadBodega;
                                ...
                                sql1 = " INSERT INTO Compras (Proveedor,Categoria,Producto,Precio,Cantidad,Importe,Fecha,Factura) VALUES ('" + TextBox_Proveedor.Text + "','" + TextBox_Categoria.Text + "','" +
                                ...
                                if (Connect1.Insertar(sql1))
                                {
                                    ...
                                    {
                                        string campo2 = " CltProv = '" + TextBox_Proveedor.Text +
         ...
         //                                   GridView2.DataBind();
                                            ...
                                            foreach(DataRow row1 in Connect3.Consultar7("*","Compras", "Proveedor", TextBox_Proveedor.Text,"Factura", TextBox_Factura.Text).Rows)
                                            {
                                            ...
                                            GridView4.DataSource = Connect4.Consultar7(campos3, "Compras", "Proveedor", TextBox_Proveedor.Text, "Factura",TextBox_Factura.Text);
                                            GridView4.DataBind();
        ...
        {
            Response.Redirect("CompraProductos.aspx");
        }
        ...
        protected void GridView2_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            GridView1.DataSource = Connect2.Consultar2("Id, Proveedor","Proveedores");
            GridView2.DataBind();
        ...
        protected void GridView2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (DataRow row in Connect1.Consultar4("*", "Proveedores", "Id", Id).Rows)
            {

                TextBox_Proveedor.Text = Convert.ToString(row[1]);
            ...
            foreach (DataRow row in Connect2.Consultar4("*", "Facturas", "CltProv", TextBox_Proveedor.Text).Rows)
            {
        ...
        protected void TextBox_Buscar2_TextChanged(object sender, EventArgs e)
        {
             ...
             GridView2.DataSource = Connect1.Consultar4("Id, Proveedor","Proveedores", "Proveedor",TextBox_Buscar2.Text);
            GridView2.DataBind();
       }

        protected void GridView3_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            string campos4 = " Proveedor,Categoria,Producto,Precio,Cantidad,Importe,Factura";
            GridView3.PageIndex = e.NewPageIndex;
            GridView3.DataSource = Connect4.Consultar4(campos4, "Compras", "Fecha", TextBox_Fecha.Text);
            GridView3.DataBind();
        ...
        {
            string campos4 = " Proveedor,Categoria,Producto,Precio,Cantidad,Importe,Factura";
            GridView3.DataSource = Connect1.Consultar8(campos4, "Compras", "Fecha", TextBox_Fecha.Text,"Proveedor",TextBox_Buscar3.Text);
            GridView3.DataBind();
        ...
        protected void GridView4_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            foreach(DataRow row in Connect1.Consultar4("*", "Compras", "Id", Id).Rows)
            {
            ...
            if(texto.Text == "yes")
            {
                ...
                {
                    if(Connect1.Eliminar("Compras", " Id = '" + Id + "'"))
                    {
                        foreach (DataRow row in Connect4.Consultar7("*", "Compras", "Proveedor", TextBox_Proveedor.Text, "Factura", TextBox_Factura.Text).Rows)
                        {
                        ...
                        string campos2 =" Proveedor, Categoria, Producto, Precio , Cantidad, Importe, Factura";

                        GridView3.DataSource = Connect4.Consultar4(campos2, "Compras", "Fecha", TextBox_Fecha.Text);
                        GridView3.DataBind();


                        string campos3 = "Id,Categoria,Producto,Precio,Cantidad,Importe";

                        GridView4.DataSource = Connect5.Consultar7(campos3, "Compras", "Proveedor",
                            TextBox_Proveedor.Text, "Factura", TextBox_Factura.Text);
